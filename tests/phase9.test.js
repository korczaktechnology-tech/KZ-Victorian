...
test("Fase 9: manifesto separa carregamento essencial e opcional",()=>{assert.ok(Array.isArray(ASSET_MANIFEST.essential));assert.ok(Array.isArray(ASSET_MANIFEST.optional));assert.equal(ASSET_MANIFEST.policy.models,".glb");});
