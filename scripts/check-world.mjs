...
if(!source.includes("memory?.regions?.terrain") && source.includes("navigationRevision")||!source.includes("rebuildNavigation"))throw new Error("Fase 6: invalidação/rebuild de navegação ausente.");
