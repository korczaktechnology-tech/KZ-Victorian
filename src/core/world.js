...
export function createSimulationWorld(memory=null,capacity=MEMORY_CAPACITIES.entities,width=WORLD.DEFAULT_WIDTH,height=WORLD.DEFAULT_HEIGHT){
 ...
 const world={entities,memory,map,spatial,flowFields,tick:0,events:[],metrics:{population:0,moving:0,lowNeeds:0,completedConstruction:0,produced:0,logistics:0,economyTransfers:0,navigationRevision:0},navigation:{activeField:null},logisticsTasks:new Map(),logisticsRequests:new Map(),nextLogisticsRequestId:1,productionJobs:new Map(),
