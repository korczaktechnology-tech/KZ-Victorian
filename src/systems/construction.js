...
export function requestConstruction(world,type,x,y,z=0){
 ...
 world.emit("resourceChanged",{entityId:warehouse,resource:RESOURCE.WOOD,quantity:-required[RESOURCE.WOOD]});
 world.emit("resourceChanged",{entityId:warehouse,resource:RESOURCE.STONE,quantity:-required[RESOURCE.STONE]});
