export class Camera{
 constructor(){this.x=128;this.y=128;this.zoom=1;this.height=155;this.pitch=.86;this.yaw=0;this.fov=.82;}
 ...
 moveLocal(forward=0,right=0){
  ...
  // Y é o eixo Z lógico do mapa. Yaw 0 olha para +Z: W = +Z e D = +X.
