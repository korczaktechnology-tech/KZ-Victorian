...
function drawPart(gl,loc,mesh,x,y,z,sx,sy,sz,color,yaw){gl.uniform3f(loc.translation,x,y,z);gl.uniform3f(loc.scale,sx,sy,sz);gl.uniform1f(loc.yaw,yaw);gl.uniform4f(loc.color,...color);gl.drawElements(gl.TRIANGLES,mesh.count,gl.UNSIGNED_SHORT,0);}
